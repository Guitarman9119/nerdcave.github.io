...
! function (e, t) {
    ...
    i.f = O ? B : function (e, t) {
        if (e = F(e), t = z(t, !0), U) try {
            return B(e, t)
        } catch (e) {}
    ...
    _.f = V ? X : function (e, t, n) {
        if (Y(e), t = $(t, !0), Y(n), K) try {
            return X(e, t, n)
        } catch (e) {}
    ...
    (Z.exports = function (e, t, n, i) {
        var r, a = !!i && !!i.unsafe,
            o = !!i && !!i.enumerable,
            s = !!i && !!i.noTargetGet;
        "function" == typeof n && ("string" != typeof t || _e(n, "name") || Be(n, "name", t), (r = Ke(n)).source || (r.source = Ye.join("string" == typeof t ? t : ""))), e !== Ue ? (a ? !s && e[t] && (o = !0) : delete e[t], o ? e[t] = n : Be(e, t, n)) : o ? e[t] = n : qe(t, n)
    ...
    var At = Ze,
        ...
        ln = !on || Zt((function () {
            ...
            for (var n = rn(e), i = arguments.length, r = 1, a = tn.f, o = nn.f; i > r;)
                for (var s, l = an(arguments[r++]), c = a ? en(l).concat(a(l)) : en(l), u = c.length, d = 0; u > d;) s = c[d++], Qt && !o.call(l, s) || (n[s] = l[s]);
            return n
        } : on;
    $t({
        target: "Object",
    ...
    var Sn = un && +un,
        ...
        Kn = function (e) {
            ...
            return function (l, c, u, d) {
                for (var h, f, v = _n(l), g = Bn(v), p = Un(c, u, 3), m = qn(g.length), y = 0, b = d || Wn, w = t ? b(l, m) : n || o ? b(l, 0) : void 0; m > y; y++)
    ...
    _r && qr || (_r = function (e) {
        ...
        Kr.now(Jr(e))
    } : Vr && !Hr ? (Rr = (Ar = new Vr).port2, Ar.port1.onmessage = Qr, kr = Dr(Rr.postMessage, Rr, 1)) : Or.addEventListener && "function" == typeof postMessage && !Or.importScripts && Br && "file:" !== Br.protocol && !jr(Zr) ? (kr = Zr, Or.addEventListener("message", Qr, !1)) : kr = Xr in zr("script") ? function (e) {
    ...
    if (xo && (po = (go = function (e) {
        ...
        Ca = vo.then, Ro || (Ha(vo, "then", (function (e, t) {
            var n = this;
    ...
    var Yo = W,
        ...
        ns = function (e) {
            ...
            if (d && (u = Xo(u, c > 2 ? arguments[2] : void 0, 2)), null == h || l == Array && Qo(h))
                ...
                for (a = (r = h.call(s)).next, n = new l; !(i = a.call(r)).done; f++) o = d ? Jo(r, u, [i.value, f], !0) : i.value, es(n, f, o);
            return n.length = f, n
        };
    $t({
        target: "Array",
    ...
    var Hs = Object.create || function (e, t) {
            var n;
            return null !== e ? (Ds.prototype = Cs(e), n = new Ds, Ds.prototype = null, n[js] = e) : n = zs(), void 0 === t ? n : Ns(n, t)
        },
        ...
        cl = function (e, t, n, i, r, a, o) {
            ...
            if (p && (s = $s(p.call(new e)), el !== Object.prototype && s.next && ($s(s) !== el && (Xs ? Xs(s, el) : "function" != typeof s[nl] && Js(s, nl, ol)), Gs(s, d, !0))), r == rl && v && v.name !== rl && (h = !0, g = function () {
                    return v.call(this)
    ...
    var Nl = $e,
        ...
        Dc = function (e, t, n) {
            ...
            return Wl(n), Bl(xc, i) ? (n.enumerable ? (Bl(e, vc) && e[vc][i] && (e[vc][i] = !1), n = Xl(n, {
                enumerable: $l(0, !1)
            })) : (Bl(e, vc) || kc(e, vc, $l(1, {})), e[vc][i] = !0), Tc(e, i, n)) : kc(e, i, n)
        },
        Fc = function (e, t) {
            Wl(e);
            var n = Kl(t),
    ...
    (zl || (rc((wc = function () {
        ...
        return Oc(sc(e), e)
    })), nc.f = zc, tc.f = Dc, ec.f = Hc, Jl.f = Ql.f = Uc, Zl.f = Bc, cc.f = function (e) {
        return Oc(lc(e), e)
        ...
        stringify: function (e, t, n) {
            ...
            if (i = t, (ql(t) || void 0 !== e) && !jc(e)) return _l(t) || (t = function (e, t) {
                if ("function" == typeof i && (t = i.call(this, e, t)), !jc(t)) return t
    ...
    nd("split", 2, (function (e, t, n) {
        ...
        return i = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (e, n) {
            ...
            for (var a, o, s, l = [], c = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), u = 0, d = new RegExp(e.source, c + "g");
                (a = ud.call(d, i)) && !((o = d.lastIndex) > u && (l.push(i.slice(u, a.index)), a.length > 1 && a.index < i.length && hd.apply(l, a.slice(1)), s = a[0].length, u = o, l.length >= r));) d.lastIndex === a.index && d.lastIndex++;
    ...
    if (bd(Md, !Id(" 0o1") || !Id("0b1") || Id("+0x1"))) {
        for (var Dd, Fd = function (e) {
                var t = arguments.length < 1 ? 0 : e,
                    n = this;
                return n instanceof Fd && (Od ? Rd((function () {
                    Td.valueOf.call(n)
                })) : Ed(n) != Md) ? kd(new Id(jd(t)), n, Fd) : jd(t)
            }, zd = md ? Ld(Id) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger,fromString,range".split(","), Hd = 0; zd.length > Hd; Hd++) Sd(Id, Dd = zd[Hd]) && !Sd(Fd, Dd) && Cd(Fd, Dd, Pd(Id, Dd));
        ...
        _h = function () {
            ...
            return Ri(e, [{
                ...
                value: function () {
                    var e = this,
                        t = function (t, n, i) {
                            kh(e.Reveal.getSlidesElement(), "iframe[" + t + '*="' + n + '"]').forEach((function (e) {
    ...
    var lf = 0,
            ...
            return Ri(e, [{
                ...
                value: function (e) {
                    ...
                    if (!(r || a || o || s)) {
                        ...
                        var u, d, h = "linear" === t.navigationMode || !this.Reveal.hasHorizontalSlides() || !this.Reveal.hasVerticalSlides(),
                            f = !1;
                        if ("object" === Si(t.keyboard))
                            for (l in t.keyboard)
                                if (parseInt(l, 10) === n) {
        ...
        Sf = function (e) {
            return function (t) {
                for (var n, i = bf(t), r = yf(i), a = r.length, o = 0, s = []; a > o;) n = r[o++], mf && !wf.call(i, n) || s.push(e ? [n, i[n]] : i[n]);
                return s
            }
        },
        Ef = {
    ...
    $t({
        ...
        fill: function (e) {
            for (var t = Mf(this), n = Tf(t.length), i = arguments.length, r = If(i > 1 ? arguments[1] : void 0, n), a = i > 2 ? arguments[2] : void 0, o = void 0 === a ? n : If(a, n); o > r;) t[r++] = e;
            return t
        }
    }), zf("fill");
    var Hf = function () {
    ...
    function _f(e, t) {
        ...
        function D(n) {
            ...
            return l = wi(wi(wi(wi(wi({}, Uf), l), t), n), Mh()), F(), window.addEventListener("load", oe, !1), M.load(l.plugins, l.dependencies).then(z), new Promise((function (e) {
                return s.on("ready", e)
            }))
        }
        ...
        function z() {
            c = !0, H(), U(), V(), W(), Ae(), K(), L.readURL(), k.update(!0), setTimeout((function () {
        ...
        function Ee() {
            $(), Y(), oe(), p = l.autoSlide, We(), k.create(), L.writeURL(), A.sortAll(), P.update(), C.update(), Le(), j.update(), j.updateVisibility(), k.update(!0), S.update(), w.formatEmbeddedContent(), !1 === l.autoPlayMedia ? w.stopEmbeddedContent(a, {
                unloadIframes: !1
        ...
        function Qe() {
            ...
            if (r || !1 === A.prev())
                ...
                else if ((e = l.rtl ? kh(v.wrapper, ".slides>section.future").pop() : kh(v.wrapper, ".slides>section.past").pop()) && e.classList.contains("stack")) {
    ...
    return qf.initialize = function (e) {
        return Object.assign(qf, new _f(document.querySelector(".reveal"), e)), Wf.map((function (e) {
            return e(qf)
        })), qf.initialize()
